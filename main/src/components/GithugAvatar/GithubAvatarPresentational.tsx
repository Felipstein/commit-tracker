...
export function GithubAvatarPresentationalRoot({ className, children }: GithubAvatarPresentationalRootProps) {
...
export function GithubAvatarPresentationalImage({ src, alt, width = 32, height = 32, className }: GithubAvatarPresentationalImageProps) {
...
export function GithubAvatarPresentational(props: GithubAvatarPresentationalImageProps) {
